...
public class IrondumpBlock extends FunModsModElements.ModElement {
	@ObjectHolder("fun_mods:irondump")
	public static final Block block = null;
	public IrondumpBlock(FunModsModElements instance) {
		super(instance, 87);
	...
	private static class CustomRuleTest extends RuleTest {
		...
		public boolean test(BlockState blockAt, Random random) {
			...
			if (blockAt.getBlock() == TrashBlockBlock.block.getDefaultState().getBlock())
				blockCriteria = true;
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("fun_mods:irondump_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("irondump"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("fun_mods:irondump"), configuredFeature);
		}
	}
	@SubscribeEvent
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		boolean biomeCriteria = false;
		if (new ResourceLocation("fun_mods:dump").equals(event.getName()))
			biomeCriteria = true;
		if (!biomeCriteria)
			return;
