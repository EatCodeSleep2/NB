...
public class OrbitStoneBlock extends FunModsModElements.ModElement {

	@ObjectHolder("fun_mods:orbit_stone")
	public static final Block block = null;

	public OrbitStoneBlock(FunModsModElements instance) {
		super(instance, 60);
