...
public class OrbitoreBlock extends FunModsModElements.ModElement {
	@ObjectHolder("fun_mods:orbitore")
	public static final Block block = null;
	public OrbitoreBlock(FunModsModElements instance) {
		super(instance, 23);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("fun_mods:orbitore_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("orbitore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("fun_mods:orbitore"), configuredFeature);
		}
	}
	@SubscribeEvent
