...
public class RocketBoosterTierIBlock extends FunModsModElements.ModElement {
	@ObjectHolder("fun_mods:rocket_booster_tier_i")
	public static final Block block = null;
	public RocketBoosterTierIBlock(FunModsModElements instance) {
		super(instance, 34);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("rocket_booster_tier_i");
		}
