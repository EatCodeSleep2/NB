...
public class OrbitblockBlock extends FunModsModElements.ModElement {
	@ObjectHolder("fun_mods:orbitblock")
	public static final Block block = null;
	public OrbitblockBlock(FunModsModElements instance) {
		super(instance, 19);
	}
