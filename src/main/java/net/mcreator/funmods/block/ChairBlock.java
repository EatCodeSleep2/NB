...
public class ChairBlock extends FunModsModElements.ModElement {
	@ObjectHolder("fun_mods:chair")
	public static final Block block = null;
	public ChairBlock(FunModsModElements instance) {
		super(instance, 95);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(3f, 1f).setLightLevel(s -> 0).notSolid()
