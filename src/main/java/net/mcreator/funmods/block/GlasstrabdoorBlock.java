...
public class GlasstrabdoorBlock extends FunModsModElements.ModElement {
	@ObjectHolder("fun_mods:glasstrabdoor")
	public static final Block block = null;
	public GlasstrabdoorBlock(FunModsModElements instance) {
		super(instance, 1);
	}
