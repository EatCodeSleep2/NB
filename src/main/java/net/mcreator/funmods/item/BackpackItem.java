...
import net.mcreator.funmods.gui.BackpackLowGuiWindow;
import net.mcreator.funmods.gui.BackpackLowGui;
...
public class BackpackItem extends FunModsModElements.ModElement {
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof BackpackLowGuiWindow) {
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new BackpackLowGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
