...
public class RainboxingotItem extends FunModsModElements.ModElement {
	@ObjectHolder("fun_mods:rainboxingot")
	public static final Item block = null;
	public RainboxingotItem(FunModsModElements instance) {
		super(instance, 8);
	}
