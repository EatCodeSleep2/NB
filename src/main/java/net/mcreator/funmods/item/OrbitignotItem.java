...
public class OrbitignotItem extends FunModsModElements.ModElement {
	@ObjectHolder("fun_mods:orbitignot")
	public static final Item block = null;
	public OrbitignotItem(FunModsModElements instance) {
		super(instance, 3);
	}
