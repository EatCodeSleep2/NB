...
public class SnownyJungleBiome extends FunModsModElements.ModElement {

	public static Biome biome;

	public SnownyJungleBiome(FunModsModElements instance) {
		super(instance, 65);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-1).setWaterColor(-10027009).setWaterFogColor(-10027009)
						.withSkyColor(-1).withFoliageColor(10387789).withGrassColor(-3355444).build();
				...
				event.getRegistry().register(biome.setRegistryName("fun_mods:snowny_jungle"));
			}
		}
