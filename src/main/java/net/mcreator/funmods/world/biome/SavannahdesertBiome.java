...
public class SavannahdesertBiome extends FunModsModElements.ModElement {
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-16711732).setWaterColor(-16724788).setWaterFogColor(-16711732)
						.withSkyColor(-16711732).withFoliageColor(10387789).withGrassColor(-3355648).build();
				...
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(Blocks.ACACIA_LEAVES.getDefaultState()),
